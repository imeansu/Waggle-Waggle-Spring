...
class ConversationServiceImplTest {
    ...
    public void redis_삭제_테스트(){
        ...
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberC).hearingMemberId(memberA).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberA).hearingMemberId(memberC).build());
        conversationService.joinRoom(memberD);
        conversationService.vivoxMemberOut(PhotonMemberInOutDto.builder().sayingMemberId(memberA).hearingMemberId(memberC).build());
        conversationService.vivoxMemberOut(PhotonMemberInOutDto.builder().sayingMemberId(memberC).hearingMemberId(memberA).build());
        conversationService.vivoxMemberOut(PhotonMemberInOutDto.builder().sayingMemberId(memberC).hearingMemberId(memberA).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberC).hearingMemberId(memberD).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberD).hearingMemberId(memberC).build());
        ...
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberD).hearingMemberId(memberE).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberE).hearingMemberId(memberD).build());
        conversationService.sentence(PhotonConversationDto.builder().roomId(roomId).sentence("오징어 게임 보셨어요?").memberId(memberC).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberC).hearingMemberId(memberE).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberE).hearingMemberId(memberC).build());
        ...
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberA).hearingMemberId(memberB).build());
        conversationService.vivoxMemberIn(PhotonMemberInOutDto.builder().sayingMemberId(memberB).hearingMemberId(memberA).build());
